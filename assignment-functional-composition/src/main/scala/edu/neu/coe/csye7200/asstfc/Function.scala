...
object Function {
  ...
  /**
    ...
    */
  // You know this one
  def lift[T, R](f: T => R): Try[T] => Try[R] = a => a map f // TO BE IMPLEMENTED
  ...
  def lift2[T1, T2, R](f: (T1, T2) => R): (Try[T1], Try[T2]) => Try[R] = (a,b) => map2(a,b)(f)
  // TO BE IMPLEMENTED
  ...
  def lift3[T1, T2, T3, R](f: (T1, T2, T3) => R): (Try[T1], Try[T2], Try[T3]) => Try[R] = (a,b,c) => map3(a,b,c)(f) // TO BE IMPLEMENTED
  ...
  (Try[T1], Try[T2], Try[T3], Try[T4], Try[T5], Try[T6], Try[T7]) => Try[R] = (a1,a2,a3,a4,a5,a6,a7) => map7(a1,a2,a3,a4,a5,a6,a7)(f) // TO BE IMPLEMENTED
  ...
  def invert2[T1, T2, R](f: T1 => T2 => R): T2 => T1 => R = b=>a=>f(a)(b) // TO BE IMPLEMENTED
  ...
  def invert3[T1, T2, T3, R](f: T1 => T2 => T3 => R): T3 => T2 => T1 => R = c=>b=>a=>f(a)(b)(c) // TO BE IMPLEMENTED
  ...
  def invert4[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): T4 => T3 => T2 => T1 => R = d=>c=>b=>a=>f(a)(b)(c)(d) // TO BE IMPLEMENTED
  ...
  def uncurried2[T1, T2, T3, R](f: T1 => T2 => T3 => R): (T1, T2) => T3 => R = (a,b)=>c=>f(a)(b)(c) // TO BE IMPLEMENTED
  ...
  def uncurried3[T1, T2, T3, T4, R](f: T1 => T2 => T3 => T4 => R): (T1, T2, T3) => T4 => R = (a,b,c)=>d=>f(a)(b)(c)(d) // TO BE IMPLEMENTED
  ...
  def uncurried7[T1, T2, T3, T4, T5, T6, T7, T8, R](f: T1 => T2 => T3 => T4 => T5 => T6 => T7 => T8 => R): (T1, T2, T3, T4, T5, T6, T7) => T8 => R = (a1,a2,a3,a4,a5,a6,a7)=>a8=>f(a1)(a2)(a3)(a4)(a5)(a6)(a7)(a8)
   // TO BE IMPLEMENTED
